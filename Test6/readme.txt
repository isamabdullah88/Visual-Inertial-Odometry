...
number of camera States tracked has been increased, and the number of detected features also have been increased.
Also, the in-between update has been ENABLED.
Detect Threshold has been disabled.
Following are the values:

camStates: 15
no of features detected: 100 (corner)
