function[ points ] = extractPointsToTrack( img )
%extractPointsToTrack This function extracts good features to track
%   This function is only called when there is new point to track
