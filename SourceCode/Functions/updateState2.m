function[ State, costVec ] = updateStateandCov( State, trackedPts, noiseParams, camParams, costVec )
...
[State, costVec] = updateState(State, trackedPts, noiseParams, camParams, costVec);
